    ...
    def create_assistant(self):
        ...
        while True:
            ...
            for i in range(len(assistants)):
                ...
                self.console.rule("")
                self.print("\t{}. [bold red]{}[/bold red]\t[ID: [bold green]{}[/bold green]  model: [bold green]{}[/bold green]  temp: [bold green]{}[/bold green]]".format(i, assistant.name, assistant.id, assistant.model, assistant.temperature))
            ...
            selected = self.user_input("Select an existing assistant or enter 'n' to create a new one> ")
            if selected == 'n':
                ...
                enable_code_interpreter = self.user_input("Enable code interpreter> (N/y)")
                if enable_code_interpreter == 'y':
                    enable_code_interpreter = True
                else:
                    enable_code_interpreter = False
                session.create_assistant(name=name, instructions=instructions, file_search=enable_file_search, code_interpreter=enable_code_interpreter)
                self.console.clear()
                continue
            try:
            ...
            self.cfg.save_selected_assistant(selected_assistant.name, selected_assistant.id)
            break
