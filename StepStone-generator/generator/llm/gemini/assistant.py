...
class GeminiAssistant(LLM):
    def __init__(
        ...
        self._doc_context: str | None = None
        super().set_api_key(api_key)

    def load_doc(self, file_path: str) -> None:
        with open(file_path, "r") as f:
            self._doc_context = f.read()
    ...
    def retrieve_assistant(self, assistant_id: str) -> None:
        # no-op: replaces OpenAI assistant retrieval
        pass
    ...
    def chat(self, message: str, **kwargs) -> str | None:
        ...
        if self.logger:
            self.logger.info("> GeminiAssistant: {}".format(message))
    ...
    @log_message
    def _append_message(self, message: str, role: str) -> None:
    ...
    def _send_request(
        ...
        system_instruction = self._doc_context if self._doc_context else None
        try:
